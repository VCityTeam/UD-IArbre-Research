...
Move inside the SunpathTool directory
...
```bash
python3 sunpath.py --latitude 45.75 --longitude 4.85 -s 1975 -e 2075
```
...
Now you can use the created csv file inside of pySunlight by replacing the existing one present in `pySunlight/datas/AnnualSunPath_Lyon.csv` by your custom csv file.
