# Synthèse FLAIR-HUB sur la segmentation de la végétation urbaine 
...
- Document
  ...
  - **Date de dernière mise à jour** : 20266-01-08
  - **Version** : 1.0.0
...
## FLAIR-HUB
**FLAIR-HUB** est un outil open source issu du programme FLAIR (https://ignf.github.io/FLAIR/FLAIR-HUB/FLAIR-HUB_fr.html), développé par l’IGN. Contrairement à COSIA, il ne fournit pas une base de données déjà classifiée mais des modèles préentraînés pouvant être appliqués localement sur différentes données : orthophotos RVB, infrarouges, images SPOT, Sentinel, couplé ou pas à une carte d'altitude de terrain. 
...
Vous pouvez retrouver le Github (https://github.com/IGNF/FLAIR-HUB/tree/main) du projet ainsi que son site web (https://ignf.github.io/FLAIR/FLAIR-HUB/FLAIR-HUB.html)
...
## Références
[1] FLAIR-HUB : Large-scale Multimodal Dataset for Land Cover and Crop Mapping, Anatol Garioud, Sébastien Giordano, Nicolas David, Nicolas Gonthier, https://arxiv.org/abs/2506.07080  
[2] Swin-Unet: Unet-like Pure Transformer for Medical Image Segmentation, Hu Cao, Yueyue Wang, Joy Chen, Dongsheng Jiang, Xiaopeng, https://arxiv.org/abs/2105.05537  
[3] Bellec, A., 2018, Thèse : Analyse multi-sources pour la végétation urbaine à Lyon, https://scd-resnum.univ-lyon3.fr/out/theses/2018_out_bellec_a.pdf