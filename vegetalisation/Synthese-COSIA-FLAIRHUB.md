...
Pour avoir le résumé complet des techniques utilisé par Anrnaud Bellec afin d'obtenir ces données vous pouvez lire le document suivant : [Synthèse de la thèse d'Arnaud Bellec](Synthese-These-Arnaud-Bellec-2018.md)
