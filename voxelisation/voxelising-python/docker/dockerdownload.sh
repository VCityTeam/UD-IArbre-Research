#!/usr/bin/env bash
# The Linux/macOS twin of docker/dockerdownload.cmd.
...
# docker compose -f docker/docker-compose.yml run --rm voxelisation python -m voxelizer.download_orthos --xmin-start 1831000 --xmin-end 1832000 --ymin-start 5175000 --ymin-end 5176000 --ortho-dir inputs/ortho
