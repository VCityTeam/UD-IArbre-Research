@echo off
rem ============================================================
rem  Serves a 3-D Tiles directory and opens the iTowns viewer page.
rem
rem    Drag & drop a tileset directory (holding tileset.json) onto
rem    this file, or pass a path:
rem      scripts\serve_tiles_itowns.cmd tilesexport\Run1
rem
...
if "%~1"=="" (
    ...
    echo   scripts\serve_tiles_itowns.cmd tilesexport\Run1 [flags]
    pause
    exit /b 1
)
...
%PYTHON% -m voxelizer serve "%DIR%" --kind tiles --open-viewer itowns!REST!
