...
See `Diagrams/pipeline_dataflow_diagram.md` (Path C), `HowToUse.md` in the
package root, and `ProblemSolving.md` sections 4.1 and 6.4, which ships
beside the reports under `Presentations/Soutenance/`.
