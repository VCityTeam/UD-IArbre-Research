...
flowchart TD
    ...
    TilesOut --> ServeT["serve_tiles (HTTP) + launchers:<br>view_cesium.cmd / view_itowns.cmd /<br>launch_unreal.cmd"]
...
flowchart TD
    ...
    Launch["launchers.py<br>(generated view_*.cmd / launch_unreal.cmd)"]
    Main -. lazy .-> Serve2
    Serve2 --> CliC
    AreaOut -. lazy .-> Launch
    StageR -. lazy .-> Launch
